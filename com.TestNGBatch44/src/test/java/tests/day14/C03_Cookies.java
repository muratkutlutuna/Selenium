...
public class C03_Cookies extends TestBase {
    ...
    public void test01(){
        ...
        //4- ismi i18n-prefs olan cookie degerinin USD oldugunu test 
        String nameOfCookie = driver.manage().getCookieNamed("i18n-prefs").getName();
        System.out.println("nameOfCookie = " + nameOfCookie);
        ...
        driver.manage().deleteCookieNamed("en_sevdigim_cookie");
        Set<Cookie> cookieSet3=driver.manage().getCookies();
        sayac = 1;
        for (Cookie cookie : cookieSet3) {
            System.out.println(sayac + ". Cookie : " + cookie);
            sayac++;
        }
        Assert.assertFalse(cookieSet3.contains(driver.manage().getCookieNamed("en_sevdigim_cookie")));
        //8- tum cookie’leri silin ve silindigini test edin
        driver.manage().deleteAllCookies();
        Set<Cookie> cookieSet4=driver.manage().getCookies();
        Assert.assertTrue(cookieSet4.isEmpty());
